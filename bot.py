...
async def send_advice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = (f"{advice}\n{title}\n{url}\n\n"
           'Если хочешь получить новую рекомендацию, напиши "Еще".\n'  '"Играл" - если включал пару раз.\n' "Уже прошел" - если прошел.\n'"Неинтересно" — И мы отправим это в папку подальше. Я это запомню и по команде "Пройденные" будет видна твою библиотека.\n'
           '"Спасибо" - Если вариант подходящий.'"Пока" - если пора прощаться')
