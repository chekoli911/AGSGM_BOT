...
advice_texts = [
    ...
    "Эй, смотри-ка, вот что я тебе подкинул!",
    "Если скучно — попробуй это безумие.",
    "Не скажу, что это шедевр, но точно зайдёт.",
    "Готов к новым ощущениям? Тогда эта игра для тебя.",
    "Ты ещё не играл в это? Позор!",
    "Заскочишь сюда — не пожалеешь.",
    "Это что-то с чем-то, попробуй разобраться.",
    "Включай и погружайся, времени жалко не будет.",
    "Загадка дня: эта игра твоя следующая цель.",
    "Когда всё надоело, вот тебе спасение.",
    "Почувствуй вкус приключений с этой игрой.",
    "Заряд бодрости и эмоций в одной упаковке.",
    "Порция драйва на вечер — не пропусти.",
    "Лучше один раз попробовать, чем сто раз услышать.",
    "Заценишь? Должен заценить!",
    "Игра, которая сожжёт твои выходные.",
    "Взрыв мозга гарантирован, попробуй сам.",
    "Отложи всё и погнали.",
    "Твой новый фаворит уже ждёт.",
    "Ставь на паузу жизнь и запускай эту игру."
]
